...
def sample_profile():
    return MasterProfile(
        contact=ContactInfo(
            ...
            location="Indonesia",
            github_url="https://github.com/NadhifFauzilAdhim",
            linkedin_url="https://linkedin.com/in/nadhiffauziladhim"
        ),
...
def test_form_solver(sample_profile):
    ...
    assert solver.answer_question("What is your full name?") == "Nadhif Fauzil Adhim"
    assert solver.answer_question("Enter your email address") == "nadhiffauzil@gmail.com"
